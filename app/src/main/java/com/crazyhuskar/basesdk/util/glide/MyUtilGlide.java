package com.crazyhuskar.basesdk.util.glide;
...
import com.crazyhuskar.basesdk.util.MyUtilFile;
...
public class MyUtilGlide {
    ...
    public static String getCacheSize() {
        try {
            return MyUtilFile.getFormatSize(MyUtilFile.getFolderSize(new File(SystemConfig.PHOTO_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
