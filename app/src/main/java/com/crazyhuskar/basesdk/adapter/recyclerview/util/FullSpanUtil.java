package com.crazyhuskar.basesdk.adapter.recyclerview.util;
...
public class FullSpanUtil {
    ...
    public static void onAttachedToRecyclerView(RecyclerView recyclerView, final RecyclerView.Adapter adapter,
    ...
    @SuppressWarnings("rawtypes")
    public static void onViewAttachedToWindow(RecyclerView.ViewHolder holder, RecyclerView.Adapter adapter,
                                              int pinnedHeaderType) {
