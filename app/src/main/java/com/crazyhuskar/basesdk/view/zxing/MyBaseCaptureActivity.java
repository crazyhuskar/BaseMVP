package com.crazyhuskar.basesdk.view.zxing;
...
import com.crazyhuskar.basesdk.activity.MyBaseActivity;
import com.crazyhuskar.basesdk.view.zxing.camera.CameraManager;
...
public abstract class MyBaseCaptureActivity extends MyBaseActivity implements SurfaceHolder.Callback {

    private static final String TAG = MyBaseCaptureActivity.class.getSimpleName();
