package com.crazyhuskar.basesdk.view.tubiao;
...
public class MPChartHelper {
    ...
    public static void setBarChart(BarChart barChart, List<String> xAxisValue, List<Float> yAxisValue, String title, float xAxisTextSize, Integer barColor) {
        ...
        //设置自定义的markerView
        MPChartMarkerView markerView = new MPChartMarkerView(barChart.getContext(), R.layout.tubiao_marker_view);
     ...
     * @param bartitle2
     */
    public static void setTwoBarChart(BarChart barChart, final List<String> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, String bartilte1, String bartitle2, int barcolor1, int barcolor2) {
        barChart.getDescription().setEnabled(false);//设置描述
        barChart.setPinchZoom(true);//设置按比例放缩柱状图
        ...
        xAxis.setDrawGridLines(false);//不绘制格网线
        xAxis.setGranularity(1f);//设置最小间隔，防止当放大时，出现重复标签。
        xAxis.setValueFormatter(new StringAxisValueFormatter(xAxisValue));
        xAxis.setLabelCount(xAxisValue.size());//设置标签显示的个数
...
//        leftAxis.setAxisMinimum(0f);//设置Y轴最小值
        ...
        //设置柱状图数据
        setTwoBarChartData(barChart, xAxisValue, yAxisValue1, yAxisValue2, bartilte1, bartitle2, barcolor1, barcolor2);
     ...
     * 设置柱状图数据源
     */
    private static void setTwoBarChartData(BarChart barChart, List<String> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, String bartilte1, String bartitle2, int barcolor1, int barcolor2) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            if (barcolor1 == 0) {
                dataset1.setColor(ContextCompat.getColor(barChart.getContext(), R.color.bar1));
            } else {
                dataset1.setColor(barcolor1);
            }
            if (barcolor2 == 0) {
                dataset2.setColor(ContextCompat.getColor(barChart.getContext(), R.color.bar2));
            } else {
                dataset2.setColor(barcolor2);
            }
            ArrayList<IBarDataSet> dataSets = new ArrayList<>();
     ...
     * @param bartitle3
     */
    public static void setThreeBarChart(BarChart barChart, List<String> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, List<Float> yAxisValue3, String bartilte1, String bartitle2, String bartitle3, int barcolor1, int barcolor2, int barcolor3) {
        barChart.getDescription().setEnabled(false);//设置描述
        barChart.setPinchZoom(true);//设置按比例放缩柱状图
        ...
        //设置柱状图数据
        setThreeBarChartData(barChart, xAxisValue, yAxisValue1, yAxisValue2, yAxisValue3, bartilte1, bartitle2, bartitle3, barcolor1, barcolor2, barcolor3);
        barChart.setExtraBottomOffset(10);//距视图窗口底部的偏移，类似与paddingbottom
        barChart.setExtraTopOffset(30);//距视图窗口顶部的偏移，类似与paddingtop
        barChart.setFitBars(true);//使两侧的柱图完全显示
        barChart.animateX(1500);//数据显示动画，从左往右依次显示
     ...
     * @param bartitle3
     */
    private static void setThreeBarChartData(BarChart barChart, List<String> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, List<Float> yAxisValue3, String bartilte1, String bartitle2, String bartitle3, int barcolor1, int barcolor2, int barcolor3) {
    ...
    public static void setLinesChart(LineChart lineChart, List<String> xAxisValue, List<List<Float>> yXAxisValues, List<String> titles, boolean showSetValues, int[] lineColors) {
        ...
        MPChartMarkerView markerView = new MPChartMarkerView(lineChart.getContext(), R.layout.tubiao_marker_view);
    ...
    public static void setCombineChart(CombinedChart combineChart, final List<String> xAxisValues, List<Float> lineValues, List<Float> barValues, String lineTitle, String barTitle) {
        ...
        MPChartMarkerView markerView = new MPChartMarkerView(combineChart.getContext(), R.layout.tubiao_marker_view);
