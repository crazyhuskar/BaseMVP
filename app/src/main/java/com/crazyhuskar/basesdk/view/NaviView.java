...
public class NaviView extends LinearLayout {
    ...
    public NaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.NaviView, defStyleAttr, 0);
        mBigIconSrc = ta.getResourceId(R.styleable.NaviView_bigIconSrc, R.drawable.default_photo_24dp);
        mSmallIconSrc = ta.getResourceId(R.styleable.NaviView_smallIconSrc, R.drawable.default_photo_24dp);
        mIconWidth = ta.getDimension(R.styleable.NaviView_iconWidth, dp2px(context, 60));
        mIconHeight = ta.getDimension(R.styleable.NaviView_iconHeight, dp2px(context, 60));
        mRange = ta.getFloat(R.styleable.NaviView_range, 1);
        ta.recycle();
    ...
    private void init(Context context) {
        mView = inflate(context, R.layout.naviview_icon, null);
