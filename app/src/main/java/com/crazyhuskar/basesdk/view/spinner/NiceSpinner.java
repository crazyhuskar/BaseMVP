package com.crazyhuskar.basesdk.view.spinner;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.nicespinner_selector);
//        setBackgroundResource(backgroundSelector);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.nicespinner_drawable));
        } else {
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.mipmap.nicespinner_drop_down_shadow));
        }
        ...
        if (!isArrowHide) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.nicespinner_arrow);
